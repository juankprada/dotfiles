...
** Programming and Coding settings

I thought about making a separate section for Programming related
settings as programmin is the main goal of using Emacs.
...
*** TODO =init-python.el= Python specific settings
...
*** =init-web.el= Web, Javascript and Typescript settings
#+begin_src emacs-lisp :tangle "juank-emacs-modules/init-ruby.el"
