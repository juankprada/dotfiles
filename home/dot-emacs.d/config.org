...
#+begin_src emacs-lisp
  ...
  (use-package lsp-ui
    ...
    ;;(use-package dap-ruby) ;to load the dap adapter for your language
...
I'm not sure how I feel about having eldoc enabled all time
